...
\frame{
    ...
    \begin{columns}[onlytextwidth]
		...
		\end{column}
		\begin{column}{0.5\textwidth}
		\input{figures/demo_images/chap02_lstm}
		\end{column} 
	\end{columns}
}
...
\frame{
   	\frametitle{}
   	\vspace{-0.8em}
	\input{figures/demo_images/chap02_network1}
   	\vspace{-0.8em}
...
\frame{
    ...
    \begin{columns}[onlytextwidth]
        \begin{column}{0.5\textwidth}
	    \input{figures/demo_images/chap02_lstmblock}
		\end{column} 
		%%%%%%% new column
		\begin{column}{0.5\textwidth}
...
\frame{
	\frametitle{}
	\vspace{-1.5em}
	\input{figures/demo_images/chap02_gridlstm}
	\vspace{-2em}
