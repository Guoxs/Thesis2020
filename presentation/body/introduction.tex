...
\frame{
	...
	\end{block}
	\input{figures/demo_images/chap01_example}
}
...
\frame{
	...
	\begin{columns}[t]
		\column{.5\textwidth}
		\centering
		\includegraphics[width=\textwidth]{demo_images/FCN} \\
		\makebox[0.5\textwidth]{\tiny a. 全卷积网络[Long et al, CVPR 2015]} \\
		\includegraphics[width=\textwidth]{demo_images/zoom-out} \\
		\makebox[0.5\textwidth]{\tiny c. 卷积网络+高低层次特征融合[Mostajabi et al, CVPR 2015]} 

		\column{.5\textwidth}
		\centering
		\includegraphics[width=\textwidth]{demo_images/Deeplab} \\
		\makebox[0.5\textwidth]{\tiny b. 全卷积网络+概率图模型[Chen et al, ICLR 2015]} \\
		\vspace{0.8em}
		\includegraphics[width=\textwidth]{demo_images/LSTM} \\
...
\frame{
	\vspace{-0.6em}
	\input{figures/demo_images/chap01_networkstructure}
	\vspace{-1.2em}
	\begin{block}{目标与思路}
	\footnotesize
	\begin{itemize}
